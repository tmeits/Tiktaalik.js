MODULE Random; (* VI 19.1.2013 / 26.9.2014*)
  IMPORT Out;
  ...
  PROCEDURE Uniform*(): REAL; (* From M.Raiser, N.Wirth "Programming in Oberon" *)
    CONST
  ...
  BEGIN RETURN a+URand()*(b-a)
  END RandUniform;
   
  PROCEDURE RandUniformInt* (a,b : LONGINT) : LONGINT;
  BEGIN RETURN ENTIER(a+URand()*(b-a))
  END RandUniformInt;
